...
const Featured = () => {
    return (
        <div className="featured-item bg-fixed text-white  my-20">
            <div className='bg-[rgba(21,21,21,0.7)] h-full pt-8'>


                <SectionTitle subHeading="check it out" heading="Featured Item" ></SectionTitle>
                <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center  pb-10 gap-8  lg:pb-20 lg:pt-12 pt-5 lg:px-36 px-5 container mx-auto">
                    <div>
