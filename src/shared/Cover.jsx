...
const Cover = ({title, description, bgImg, bgColor}) => {
    return (
        <div  style={{
            ...
            <div className={`${bgColor} bg-center bg-cover h-full opacity-80 flex justify-center items-center rounded-md w-full container mx-auto ${bgColor === 'bg-white' ? 'text-black' : 'text-white'}`}>
